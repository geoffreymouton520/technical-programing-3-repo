 ...
 */
package com.geoffrey.adp.valid.classoneextension;

import com.geoffrey.adp.valid.classone.*;
 ...
 * @author 211026298
 */
public class ClassOneExtension {
    private String name;
    private String type;
    private ClassThree classThree;

    public ClassOneExtension(String name, String type, ClassThree classThree) {
        this.name = name;
        this.type = type;
